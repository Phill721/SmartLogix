...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                .csrf(AbstractHttpConfigurer::disable) // Desactivado para poder usar POST en Postman sin tokens
                .authorizeHttpRequests(auth -> auth
                        .requestMatchers("/api/inventario/**").authenticated()
                        .anyRequest().permitAll())
                .httpBasic(Customizer.withDefaults()); // Habilita la ventanita de login en Postman
